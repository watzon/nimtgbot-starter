...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, hasNext__ecfBf9bSnUlnf5OQ0NQMxpQ)(tyObject_PathIter__tllF14xUpDWpqG9ci5sg9bMg it, NimStringDesc* x) {
	NIM_BOOL result;
	nimfr_("hasNext", "/home/watzon/.choosenim/toolchains/nim-#devel/lib/pure/pathnorm"
".nim");
	result = (NIM_BOOL)0;
	nimln_(25, "/home/watzon/.choosenim/toolchains/nim-#devel/lib/pure/pathnorm"
".nim");
...
N_LIB_PRIVATE N_NIMCALL(tyTuple__1v9bKyksXWMsm0vNwmZ4EuQ, next__am1q4dBd9cls9au5CcmkX5oA)(tyObject_PathIter__tllF14xUpDWpqG9ci5sg9bMg* it, NimStringDesc* x) {
	...
	nimfr_("next", "/home/watzon/.choosenim/toolchains/nim-#devel/lib/pure/pathnorm"
".nim");
	nimZeroMem((void*)(&result), sizeof(tyTuple__1v9bKyksXWMsm0vNwmZ4EuQ));
	nimln_(28, "/home/watzon/.choosenim/toolchains/nim-#devel/lib/pure/pathnorm"
".nim");
	(*it).prev = (*it).i;
	nimln_(29, "/home/watzon/.choosenim/toolchains/nim-#devel/lib/pure/pathnorm"
".nim");
	{
		NIM_BOOL T3_;
		...
		LA4_: ;
		if (!T3_) goto LA5_;
		nimln_(31, "/home/watzon/.choosenim/toolchains/nim-#devel/lib/pure/pathnorm"
".nim");
	...
	{
		{
			nimln_(37, "/home/watzon/.choosenim/toolchains/nim-#devel/lib/pure/pathnorm"
".nim");
			while (1) {
				NIM_BOOL T10_;
	...
	LA1_: ;
	nimln_(38, "/home/watzon/.choosenim/toolchains/nim-#devel/lib/pure/pathnorm"
".nim");
	{
		NI colontmp_;
		NI colontmp__2;
		...
		nimln_(39, "/home/watzon/.choosenim/toolchains/nim-#devel/lib/pure/pathnorm"
".nim");
		colontmp_ = (*it).prev;
	...
	{
		NIM_BOOL T17_;
		nimln_(40, "/home/watzon/.choosenim/toolchains/nim-#devel/lib/pure/pathnorm"
".nim");
		T17_ = (NIM_BOOL)0;
		T17_ = hasNext__ecfBf9bSnUlnf5OQ0NQMxpQ((*it), x);
		if (!T17_) goto LA18_;
		nimln_(41, "/home/watzon/.choosenim/toolchains/nim-#devel/lib/pure/pathnorm"
".nim");
	...
	LA12_: ;
	{
		nimln_(43, "/home/watzon/.choosenim/toolchains/nim-#devel/lib/pure/pathnorm"
".nim");
		while (1) {
			NIM_BOOL T22_;
	...
	nimln_(44, "/home/watzon/.choosenim/toolchains/nim-#devel/lib/pure/pathnorm"
".nim");
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, isSlash__Sl9c33djPmHfV9bnZbQf0QBw)(NimStringDesc* x, tyTuple__1v9bKyksXWMsm0vNwmZ4EuQ bounds) {
	NIM_BOOL result;
	NIM_BOOL T1_;
	nimfr_("isSlash", "/home/watzon/.choosenim/toolchains/nim-#devel/lib/pure/pathnorm"
".nim");
	result = (NIM_BOOL)0;
	nimln_(57, "/home/watzon/.choosenim/toolchains/nim-#devel/lib/pure/pathnorm"
".nim");
	T1_ = (NIM_BOOL)0;
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, isDotDot__Sl9c33djPmHfV9bnZbQf0QBw_2)(NimStringDesc* x, tyTuple__1v9bKyksXWMsm0vNwmZ4EuQ bounds) {
	...
	nimfr_("isDotDot", "/home/watzon/.choosenim/toolchains/nim-#devel/lib/pure/pathnorm"
".nim");
	result = (NIM_BOOL)0;
	nimln_(54, "/home/watzon/.choosenim/toolchains/nim-#devel/lib/pure/pathnorm"
".nim");
	T1_ = (NIM_BOOL)0;
	T2_ = (NIM_BOOL)0;
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, isDot__Sl9c33djPmHfV9bnZbQf0QBw_3)(NimStringDesc* x, tyTuple__1v9bKyksXWMsm0vNwmZ4EuQ bounds) {
	NIM_BOOL result;
	NIM_BOOL T1_;
	nimfr_("isDot", "/home/watzon/.choosenim/toolchains/nim-#devel/lib/pure/pathnorm"
".nim");
	result = (NIM_BOOL)0;
	nimln_(51, "/home/watzon/.choosenim/toolchains/nim-#devel/lib/pure/pathnorm"
".nim");
	T1_ = (NIM_BOOL)0;
	T1_ = (bounds.Field1 == bounds.Field0);
	if (!(T1_)) goto LA2_;
...
N_LIB_PRIVATE N_NIMCALL(void, addNormalizePath__bx9csIXjBBeHkYSkIUixO1g)(NimStringDesc* x, NimStringDesc** result, NI* state, NIM_CHAR dirSep) {
	...
	nimfr_("addNormalizePath", "/home/watzon/.choosenim/toolchains/nim-#devel/lib/pure/pathnorm"
".nim");
	nimZeroMem((void*)(&it), sizeof(tyObject_PathIter__tllF14xUpDWpqG9ci5sg9bMg));
	nimln_(66, "/home/watzon/.choosenim/toolchains/nim-#devel/lib/pure/pathnorm"
".nim");
	it.notFirst = (((NI) 0) < (NI)((NI64)((*state)) >> (NU64)(((NI) 1))));
	nimln_(67, "/home/watzon/.choosenim/toolchains/nim-#devel/lib/pure/pathnorm"
".nim");
	{
		if (!it.notFirst) goto LA3_;
		{
			nimln_(68, "/home/watzon/.choosenim/toolchains/nim-#devel/lib/pure/pathnorm"
".nim");
			while (1) {
				NIM_BOOL T7_;
	...
	LA3_: ;
	{
		nimln_(69, "/home/watzon/.choosenim/toolchains/nim-#devel/lib/pure/pathnorm"
".nim");
		while (1) {
			NIM_BOOL T11_;
			...
			if (!T11_) goto LA10;
			nimln_(70, "/home/watzon/.choosenim/toolchains/nim-#devel/lib/pure/pathnorm"
".nim");
			b = next__am1q4dBd9cls9au5CcmkX5oA((&it), x);
			nimln_(71, "/home/watzon/.choosenim/toolchains/nim-#devel/lib/pure/pathnorm"
".nim");
			{
				NIM_BOOL T14_;
				T14_ = (NIM_BOOL)0;
				...
				LA15_: ;
				if (!T14_) goto LA16_;
				nimln_(72, "/home/watzon/.choosenim/toolchains/nim-#devel/lib/pure/pathnorm"
".nim");
				{
					NIM_BOOL T20_;
					NIM_CHAR T22_;
					...
					LA21_: ;
					if (!T20_) goto LA23_;
					nimln_(73, "/home/watzon/.choosenim/toolchains/nim-#devel/lib/pure/pathnorm"
".nim");
					unsureAsgnRef((void**) (&(*result)), addChar((*result), dirSep));
				}
				LA23_: ;
				nimln_(74, "/home/watzon/.choosenim/toolchains/nim-#devel/lib/pure/pathnorm"
".nim");
				(*state) = (NI)((*state) | ((NI) 1));
			}
			goto LA12_;
			...
			{
				NIM_BOOL T26_;
				nimln_(75, "/home/watzon/.choosenim/toolchains/nim-#devel/lib/pure/pathnorm"
".nim");
				T26_ = (NIM_BOOL)0;
				T26_ = isDotDot__Sl9c33djPmHfV9bnZbQf0QBw_2(x, b);
				if (!T26_) goto LA27_;
				nimln_(76, "/home/watzon/.choosenim/toolchains/nim-#devel/lib/pure/pathnorm"
".nim");
				{
					NI d;
					if (!(((NI) 1) <= (NI)((NI64)((*state)) >> (NU64)(((NI) 1))))) goto LA31_;
					nimln_(77, "/home/watzon/.choosenim/toolchains/nim-#devel/lib/pure/pathnorm"
".nim");
					d = ((*result) ? (*result)->Sup.len : 0);
					{
						nimln_(84, "/home/watzon/.choosenim/toolchains/nim-#devel/lib/pure/pathnorm"
".nim");
						while (1) {
							NIM_BOOL T35_;
							...
							LA36_: ;
							if (!T35_) goto LA34;
							nimln_(85, "/home/watzon/.choosenim/toolchains/nim-#devel/lib/pure/pathnorm"
".nim");
							if (nimSubInt(d, ((NI) 1), &TM__DfU0iuayCGwHDN1Exp9cbKg_12)) { raiseOverflow(); };
							d = (NI)(TM__DfU0iuayCGwHDN1Exp9cbKg_12);
						} LA34: ;
					}
					nimln_(86, "/home/watzon/.choosenim/toolchains/nim-#devel/lib/pure/pathnorm"
".nim");
					{
						NI TM__DfU0iuayCGwHDN1Exp9cbKg_13;
						NI TM__DfU0iuayCGwHDN1Exp9cbKg_14;
						if (!(((NI) 0) < d)) goto LA39_;
						nimln_(87, "/home/watzon/.choosenim/toolchains/nim-#devel/lib/pure/pathnorm"
".nim");
						...
						nimln_(88, "/home/watzon/.choosenim/toolchains/nim-#devel/lib/pure/pathnorm"
".nim");
				...
				{
					NimStringDesc* T49_;
					nimln_(90, "/home/watzon/.choosenim/toolchains/nim-#devel/lib/pure/pathnorm"
".nim");
					{
						NIM_BOOL T44_;
						NIM_CHAR T46_;
						...
						LA45_: ;
						if (!T44_) goto LA47_;
						nimln_(91, "/home/watzon/.choosenim/toolchains/nim-#devel/lib/pure/pathnorm"
".nim");
						unsureAsgnRef((void**) (&(*result)), addChar((*result), dirSep));
					}
					LA47_: ;
					nimln_(92, "/home/watzon/.choosenim/toolchains/nim-#devel/lib/pure/pathnorm"
".nim");
...
appendString((*result), T49_);
			...
			{
				NIM_BOOL T51_;
				nimln_(93, "/home/watzon/.choosenim/toolchains/nim-#devel/lib/pure/pathnorm"
".nim");
				T51_ = (NIM_BOOL)0;
			...
			LA52_: ;
			{
				...
				nimln_(95, "/home/watzon/.choosenim/toolchains/nim-#devel/lib/pure/pathnorm"
".nim");
				if (!(b.Field0 <= b.Field1)) goto LA55_;
				nimln_(96, "/home/watzon/.choosenim/toolchains/nim-#devel/lib/pure/pathnorm"
".nim");
				{
					NIM_BOOL T59_;
					NIM_CHAR T61_;
					...
					LA60_: ;
					if (!T59_) goto LA62_;
					nimln_(97, "/home/watzon/.choosenim/toolchains/nim-#devel/lib/pure/pathnorm"
".nim");
					unsureAsgnRef((void**) (&(*result)), addChar((*result), dirSep));
				}
				LA62_: ;
				nimln_(98, "/home/watzon/.choosenim/toolchains/nim-#devel/lib/pure/pathnorm"
".nim");
...
appendString((*result), T64_);
				nimln_(99, "/home/watzon/.choosenim/toolchains/nim-#devel/lib/pure/pathnorm"
".nim");
	...
	nimln_(100, "/home/watzon/.choosenim/toolchains/nim-#devel/lib/pure/pathnorm"
".nim");
	{
		NIM_BOOL T67_;
		T67_ = (NIM_BOOL)0;
